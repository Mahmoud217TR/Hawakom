            ...
            <div class="card-header container-fluid">
                ...
                <marquee behavior="alternate"loop="100" bgcolor="efefef"  direction="right" width=100% hight=80% style="background-color:transparent"><b><i><h3><font color="0b0b3b"> أهلاً و سهلاً بكم  </marquee>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group d-flex flex-row-reverse">
                            <label for="address" class="col-md-3 col-form-label text-md-right">{{ __('العنوان') }}</label>
                        ...
                        <div class="form-group d-flex flex-row-reverse">
                            <label class="col-md-3 col-form-label text-md-right">{{ __('نوع المستخدم ') }}</label>

                            <div class="form-check pr-3">
                                <input class="form-check-input" type="radio" name="r-type" id="r1" value="customer" checked>
                                    <label class="form-check-label pl-2" for="exampleRadios1">مستأجر</label>
                            </div>
                            <div class="form-check pr-3">
                                <input class="form-check-input" type="radio" name="r-type" id="r2" value="owner">
                                    <label class="form-check-label" for="exampleRadios1">مالك</label>
                            </div>
                        </div>
